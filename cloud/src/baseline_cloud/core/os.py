...
def shell(*popenargs, shell: typing.Optional[bool] = True, stdout: typing.Optional[int] = DEVNULL, stderr: typing.Optional[int] = DEVNULL, **kwargs) -> typing.Union[int, CompletedProcess]:
